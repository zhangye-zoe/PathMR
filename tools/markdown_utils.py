...
<span class="highlighted-text" style='color:rgb(107, 100, 239)'>PathVR</span>
...
examples = [
    [
        ...
        "./images/demo_resources/tokyo.jpg",
    ],
    [
    ...
    [
        ...
        "./images/demo_resources/yacht.jpg",
    ],
    [
        "Can you segment the hot air balloon ?",
        "./images/demo_resources/balloon.jpg",
    ],
    [
        "Could you please give me a detailed description of the image ?",
        "./images/demo_resources/beetle.jpg",
    ],
    [
    ...
    [
        ...
        "./images/demo_resources/surfer.jpg",
    ],
    [
        "Can you segment the water around the person ?",
        "./images/demo_resources/paddle.jpg",
    ],
    [
        "Could you provide me with a detailed analysis of this photo? "
        "Please output with interleaved segmentation masks for the corresponding parts of the answer.",
    ...
    [
        ...
        "./images/demo_resources/japan.jpg",
    ],
]

title = "PathMR: A Fragmentation-Resilient Multimodal Visual Reasoning for Interpretable Pathology Diagnosis"
...
article = """
<center> This is the demo of PathMR. \n </center>
"""
