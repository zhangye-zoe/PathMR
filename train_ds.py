...
def main(args):
    ...
    if not args.eval_only:
        model.get_model().initialize_PathVR_modules(model.get_model().config)
    ...
    train_dataset = HybridDataset(
        ...
        samples_per_epoch=(
            args.batch_size
            * args.grad_accumulation_steps  # batch_size: 2 # grad_accumulation_steps: 10
...
def train(
    ...
    classification_losses = AverageMeter("ClassificationLoss", ":.4f")
    ...
    for global_step in range(args.steps_per_epoch):
        for i in range(args.grad_accumulation_steps):
            ...
            classification_loss = output_dict["classification_loss"]
            ...
            variation_losses.update(loss_value, input_dict["images"].size(0))
            model.backward(loss)
            model.step()
        ...
        if global_step % args.print_freq == 0:
            if args.distributed:
                ...
                classification_losses.all_reduce()
